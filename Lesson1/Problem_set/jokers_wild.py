...
# # My solution
# def hand_rank_with_wild(hand):
#     pos_hand = [card for card in hand
#                 if card[0] != '?']
#     if '?B' in hand:
#         if '?R' in hand:
#             return max([pos_hand + [r0+s0] + [r1+s1]
#                         for r0 in '23456789TJQKA'
#                         for s0 in 'HD'
#                         for r1 in '23456789TJQKA'
#                         for s1 in 'SC'],
#                        key = hand_rank)
#         else:
#             return max([pos_hand + [r+s]
...
#     result, maxval = None, None
#     for h in itertools.combinations(hand, 5):
#         now = hand_rank_with_wild(h)
#         val = hand_rank(now)
#         if not result or val > maxval:
#             result, maxval = now, val
#     return result
